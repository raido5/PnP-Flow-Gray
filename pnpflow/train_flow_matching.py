...
from pnpflow.dataloaders import CelebADataset, AFHQDataset, SARDataset
...
img_dir_sar = '/home/xyang/datasets/denoise_sar_dataset/SAR_test/'
    ...
    def train_FM_model(self, train_loader, opt, num_epoch):
        ...
        if self.args.dataset == "celeba":
            ...
            test_feat = AFHQDataset(
                ...
                transforms.ToTensor()]))
        elif self.args.dataset == "sar":
            test_feat = SARDataset(
                img_dir_sar, batchsize=1, transform = transforms.Compose([transforms.Resize((128, 128)), transforms.Grayscale(1),]))
        else:
